/*
fetchChunk * Licensed to the Apache Software Foundation (ASF) under one or more
 ...
 *
 * Construct an instance of TransportClient using {@link NettyTransportClientFactory}. A single
...
public class NettyTransportClient extends TransportClient {
  private final Logger logger = LoggerFactory.getLogger(NettyTransportClient.class);

  private final Channel channel;
  private final TransportResponseHandler handler;

  public NettyTransportClient(Channel channel, TransportResponseHandler handler) {
