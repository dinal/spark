...
public class YarnShuffleService extends AuxiliaryService {
  ...
  protected void serviceInit(Configuration conf) {
    ...
    TransportContext transportContext = TransportContext.ContextFactory.createTransportContext(transportConf, blockHandler);
	if (authEnabled) {
	  secretManager = new ShuffleSecretManager();
	  bootstraps.add(new SaslServerBootstrap(transportConf, secretManager));
	  shuffleServer = ((NettyTransportContext)transportContext).createServer(port, bootstraps);
	} else {
